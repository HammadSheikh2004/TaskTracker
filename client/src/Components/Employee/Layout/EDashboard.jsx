...
import { faEnvelope, faStar, faListCheck } from '@fortawesome/free-solid-svg-icons';
    ...
    const menuItems = [
        {
            ...
            </>, path: '/employee/getTask', icon: faListCheck
        },
    ];
    ...
    return (
        <Box sx={{ display: 'flex' }}>
            ...
            <Drawer variant="permanent" open={open} sx={{ backgroundColor: colors.secondaryColor, color: 'black' }}>
                <DrawerHeader>
                    <NavLink to='/employee/employeeDashboard' style={{ textDecoration: 'none', color: colors.primaryColor }}>
                        <Typography component='span' sx={{ marginRight: '30px', fontSize: '14px', fontWeight: 'bold' }}>Employee Dashboard</Typography>
                    </NavLink>
                ...
                <List sx={{ color: 'black' }}>
                    ...
                    >
                        {auth?.userImage ? (
                            <img
                                src={`${baseImageUrl}${auth.userImage}`}
                                height="200px"
                                width="200px"
                                alt="User Avatar"
