...
import { faEnvelope, faUser, faListCheck } from '@fortawesome/free-solid-svg-icons';
...
const Dashboard = () => {
    ...
    const menuItems = [
        { text: 'Send Task to Manager', path: '/admin/sendTask', icon: faEnvelope },
        { text: 'See All Users', path: '/admin/users', icon: faUser },
        { text: 'See All Task ABM', path: '/admin/allTask', icon: faListCheck },
    ];
            ...
            <Box sx={{ display: 'flex' }}>
                ...
                <Drawer variant="permanent" open={open} sx={{ backgroundColor: colors.secondaryColor, color: 'black' }}>
                    <DrawerHeader>
                        ...
                        <NavLink to='/admin/adminDashboard' style={{ textDecoration: 'none', color: colors.primaryColor }}>
                            <Typography component='span' variant='h6' sx={{ marginRight: '10px', fontWeight: 'bold' }}>Admin Dashboard</Typography>
                        </NavLink>
                    ...
                    <List sx={{ color: 'black' }}>
                        <Box sx={{ ...(open ? { display: 'block' } : { display: 'none' }), textAlign: 'center', marginBottom: '20px' }}>
                            <img src={UserAvatar} height='200px' width='200px' alt="" />
                            <Box component='div'>
                                {auth &&
